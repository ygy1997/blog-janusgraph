				...
				<div class="topbarBtn">
					<el-dropdown split-button @click="handleClick" @command="handleCommand">
						...
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item command="random">随机布局</el-dropdown-item>
							<el-dropdown-item command="force">经典力导向布局</el-dropdown-item>
							<el-dropdown-item command="comboForce">combo力导向布局</el-dropdown-item>
							...
							<el-dropdown-item command="fruchterman">Fruchterman 布局</el-dropdown-item>
