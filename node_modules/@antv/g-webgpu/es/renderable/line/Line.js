...
export var Line = (_dec = injectable(), _dec2 = inject(IDENTIFIER.Systems), _dec3 = named(IDENTIFIER.MaterialSystem), _dec4 = inject(IDENTIFIER.Systems), _dec5 = named(IDENTIFIER.GeometrySystem), _dec(_class = (_class2 = (_temp = /*#__PURE__*/function (_Renderable) {
  ...
  _createClass(Line, [{
    key: "afterEntityCreated",
    value: function afterEntityCreated() {
      var _this2 = this;
