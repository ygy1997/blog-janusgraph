                  ...
                  _loop = function _loop() {
                    ...
                    _this.mesh.forEach(function (entity, component) {
                      ...
                      if (geometryComponent && geometryComponent.aabb && meshTransform && component.aabbDirty) {
                        ...
                        var transformedCenter = vec3.transformMat4(vec3.create(), center, worldTransform);
                        var rotationScale = getRotationScale(worldTransform, mat3.create());
                        var transformedHalfExtents = vec3.transformMat3(vec3.create(), halfExtents, rotationScale);
                      ...
                      if (cullableComponent && geometryComponent) {
                        ...
                        cullableComponent.visibilityPlaneMask = _this.computeVisibilityWithPlaneMask(component.aabb, (parentCullableComponent === null || parentCullableComponent === void 0 ? void 0 : parentCullableComponent.visibilityPlaneMask) || Mask.INDETERMINATE, _this.planes || camera.getFrustum().planes);
