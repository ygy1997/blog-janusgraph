              ...
              case 0:
                ...
                try {
                  _loop = function _loop() {
                    ...
                    _this.mesh.forEach(function (entity, component) {
                      var hierarchyComponent = _this.hierarchy.getComponentByEntity(entity);

                      var cullableComponent = _this.cullable.getComponentByEntity(entity);

                      var geometryComponent = component.geometry;

                      var meshTransform = _this.transform.getComponentByEntity(entity); // update mesh.aabb


                      if (geometryComponent && geometryComponent.aabb && meshTransform && component.aabbDirty) {
                        var worldTransform = meshTransform.worldTransform; // apply transform to geometry.aabb

                        var _geometryComponent$aa = geometryComponent.aabb,
                            center = _geometryComponent$aa.center,
                            halfExtents = _geometryComponent$aa.halfExtents;

                        var transformedCenter = _glMatrix.vec3.transformMat4(_glMatrix.vec3.create(), center, worldTransform);

                        var rotationScale = (0, _math.getRotationScale)(worldTransform, _glMatrix.mat3.create());

                        var transformedHalfExtents = _glMatrix.vec3.transformMat3(_glMatrix.vec3.create(), halfExtents, rotationScale);
                      ...
                      if (cullableComponent && geometryComponent) {
                        var parentCullableComponent = _this.cullable.getComponentByEntity((hierarchyComponent === null || hierarchyComponent === void 0 ? void 0 : hierarchyComponent.parentID) || -1);

                        cullableComponent.visibilityPlaneMask = _this.computeVisibilityWithPlaneMask(component.aabb, (parentCullableComponent === null || parentCullableComponent === void 0 ? void 0 : parentCullableComponent.visibilityPlaneMask) || _Frustum.Mask.INDETERMINATE, _this.planes || camera.getFrustum().planes);
