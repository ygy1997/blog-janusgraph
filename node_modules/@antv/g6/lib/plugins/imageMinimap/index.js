...
/** @class */
function (_super) {
  (0, _tslib.__extends)(ImageMiniMap, _super);
  ...
  ImageMiniMap.prototype.initViewport = function () {
    ...
    var viewport = (0, _domUtil.createDom)("<div class=" + cfgs.viewportClassName + "\n      style='position:absolute;\n        left:0;\n        top:0;\n        box-sizing:border-box;\n        border: 2px solid #1980ff'>\n      </div>"); // 计算拖拽水平方向距离
  ...
  ImageMiniMap.prototype.updateViewport = function () {
    ...
    var invertGraphMatrix = _matrixUtil.mat3.invert([], graphMatrix);

    var minXY = (0, _math.applyMatrix)({
  ...
  ImageMiniMap.prototype.initContainer = function () {
    ...
    var container = (0, _domUtil.createDom)("<div class='" + className + "' style='width: " + cWidth + "px; height: " + cHeight + "px; overflow: hidden; position: relative;'></div>");
    ...
    var img = (0, _domUtil.createDom)("<img alt=\"\" src=\"" + this.get('graphImg') + "\" style=\"display: inline-block;\" ondragstart=\"return false;\" onselectstart=\"return false;\"/>");
    self.set('imgDOM', img);
    self.updateImgSize();
  ...
  ImageMiniMap.prototype.updateGraphImg = function (img) {
    ...
    var imgDOM = (0, _domUtil.createDom)("<img alt=\"\" src=\"" + img + "\" style=\"display: inline-block;\" ondragstart=\"return false;\" onselectstart=\"return false;\"/>");
