...
exports.default = exports.TEXT_STYLE = exports.HANDLER_STYLE = exports.DEFAULT_HANDLER_WIDTH = exports.FOREGROUND_STYLE = exports.BACKGROUND_STYLE = void 0;
...
var _controllerBtn = _interopRequireDefault(require("./controllerBtn"));
...
function () {
  function TrendTimeBar(cfg) {
    ...
    this.onMouseDown = function (handler) {
      return function (e) {
        ...
        _this.prevX = (0, _util.get)(event, 'touches.0.pageX', event.pageX); // 3. 开始滑动的时候，绑定 move 和 up 事件
    ...
    this.onMouseMove = function (e) {
      ...
      e.stopPropagation();
      e.preventDefault();
      var x = (0, _util.get)(e, 'touches.0.pageX', e.pageX); // 横向的 slider 只处理 x
    ...
    if (type === 'trend') {
      this.backgroundStyle = (0, _tslib.__assign)((0, _tslib.__assign)({}, BACKGROUND_STYLE), backgroundStyle);
    } else if (type === 'simple') {
      this.backgroundStyle = (0, _tslib.__assign)((0, _tslib.__assign)({}, SIMPLE_BACKGROUND_STYLE), backgroundStyle);
    }

    this.foregroundStyle = (0, _tslib.__assign)((0, _tslib.__assign)({}, FOREGROUND_STYLE), foregroundStyle);
    this.handlerStyle = (0, _tslib.__assign)((0, _tslib.__assign)({}, HANDLER_STYLE), handlerStyle);
    this.textStyle = (0, _tslib.__assign)((0, _tslib.__assign)({}, TEXT_STYLE), textStyle);
  ...
  TrendTimeBar.prototype.renderSlider = function () {
    ...
    if (timeBarType === 'trend' && (0, _util.size)((0, _util.get)(this.trendCfg, 'data'))) {
      var trendComponent = new _trend.default((0, _tslib.__assign)((0, _tslib.__assign)({
        x: this.x,
        y: this.y,
        width: width,
        height: height
    ...
    this.minHandlerShape = new _handler.default((0, _tslib.__assign)({
      name: 'minHandlerShape',
    ...
    this.maxHandlerShape = new _handler.default((0, _tslib.__assign)({
      name: 'maxHandlerShape',
    ...
    this.controllerBtnGroup = new _controllerBtn.default({
      group: this.group,
      x: this.x,
      y: this.y + height + 25,
      width: width,
  ...
  TrendTimeBar.prototype.bindEvents = function () {
    ...
    this.group.on(_constant.PLAY_PAUSE_BTN + ":click", function () {
    ...
    this.group.on(_constant.NEXT_STEP_BTN + ":click", function () {
      _this.currentHandler = _this.maxHandlerShape;
    ...
    this.group.on(_constant.PRE_STEP_BTN + ":click", function () {
      _this.currentHandler = _this.maxHandlerShape;
  ...
  TrendTimeBar.prototype.updateUI = function () {
    ...
    var handlerWidth = (0, _util.get)(this.handlerStyle, 'width', DEFAULT_HANDLER_WIDTH); // 设置文本
  ...
  TrendTimeBar.prototype.destory = function () {
    this.graph.off(_constant.VALUE_CHANGE);
    ...
    group.off(_constant.PLAY_PAUSE_BTN + ":click");
    group.off(_constant.NEXT_STEP_BTN + ":click");
    group.off(_constant.PRE_STEP_BTN + ":click");
