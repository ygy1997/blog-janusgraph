...
function (_super) {
  ...
  Menu.prototype.init = function () {
    ...
    var menu = (0, _domUtil.createDom)("<div class=" + (className || 'g6-component-contextmenu') + "></div>");
    (0, _domUtil.modifyCSS)(menu, {
      top: '0px',
      position: 'absolute',
      visibility: 'hidden'
    });
