...
import { EdgeConfig, GraphData, Item, ITEM_TYPE, ModelConfig, NodeConfig, Padding, ShapeStyle, TreeGraphData, LayoutConfig, GraphOptions, ModeOption, ModeType, ComboConfig, GraphAnimateConfig, StackData, HullCfg, WaterMarkerConfig, IG6GraphEvent } from '../types';
...
export interface IGraph extends EventEmitter {
   ...
   */
    ...
    */
     ...
     * 根据 hullId 删除 Hull
     */
    removeHull(hull: Hull | string): any;
    /**
     * 重新定义监听函数，复写参数类型
     */
...
export interface ITreeGraph extends IGraph {
     ...
     */
    setImageWaterMarker(imgURL: string, config: WaterMarkerConfig): any;
    /**
     * 设置文本水印
     * @param {string[]} texts 水印的文本内容
     * @param {WaterMarkerConfig} config 文本水印的配置项
     */
    setTextWaterMarker(texts: string[], config?: WaterMarkerConfig): any;
}
