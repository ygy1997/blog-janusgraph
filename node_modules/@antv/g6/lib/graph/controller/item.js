...
function () {
  ...
  ItemController.prototype.addItem = function (type, model) {
    ...
    if (mapper) {
      ...
      model = (0, _util.deepMix)({}, defaultModel, model, mappedModel);
  ...
  ItemController.prototype.setItemState = function (item, state, value) {
    ...
    if (item.hasState(stateName) === value || (0, _util.isString)(value) && item.hasState(stateName)) {
      return;
    }
