...
function () {
  ...
  EventController.prototype.initEvents = function () {
    ...
    var wheelHandler = (0, _util.wrapBehavior)(this, 'onWheelEvent'); // each(EVENTS, event => {
    //   canvas.on(event, canvasHandler);
    // });

    canvas.on('*', canvasHandler);
    this.canvasHandler = canvasHandler;
    extendEvents.push((0, _domUtil.addEventListener)(el, 'DOMMouseScroll', wheelHandler));
    extendEvents.push((0, _domUtil.addEventListener)(el, 'mousewheel', wheelHandler));
