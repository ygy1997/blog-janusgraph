 ...
 * @param callbacks
 */
var labelPropagation = function labelPropagation(data, directed, weightPropertyName, maxIteration) {
  if (directed === void 0) {
    directed = false;
  }
  ...
  var adjMatrix = (0, _math.getAdjMatrix)(data, directed); // the sum of each row in adjacent matrix
