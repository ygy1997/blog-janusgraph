...
var Base = {
  ...
  transform: _matrixUtil.transform,
  isArray: _util.isArray,
  isNumber: _util.isNumber,
  uniqueId: _util.uniqueId
};
var Util = (0, _tslib.__assign)((0, _tslib.__assign)((0, _tslib.__assign)((0, _tslib.__assign)((0, _tslib.__assign)((0, _tslib.__assign)({}, Base), BaseUtil), GraphicUtil), PathUtil), MathUtil), ColorUtil);
var _default = Util;
