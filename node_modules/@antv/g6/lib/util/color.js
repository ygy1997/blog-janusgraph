...
exports.getColorSetsBySubjectColors = exports.getColorsWithSubjectColor = exports.mixColor = void 0;
...
var mixColor = function mixColor(backColor, frontColor, frontAlpha) {
  ...
  return (0, _color.default)([(1 - frontAlpha) * bc.color[0] + frontAlpha * fc.color[0], (1 - frontAlpha) * bc.color[1] + frontAlpha * fc.color[1], (1 - frontAlpha) * bc.color[2] + frontAlpha * fc.color[2]]).rgb();
};
