...
var singleEdge = {
  ...
  getLabelStyleByPosition: function getLabelStyleByPosition(cfg, labelCfg, group) {
    ...
    var autoRotate = (0, _util.isNil)(labelCfg.autoRotate) ? this.labelAutoRotate : labelCfg.autoRotate;
...
_shape.default.registerEdge('cubic-vertical', {
  ...
  getControlPoints: function getControlPoints(cfg) {
    ...
    if ((0, _util.isNumber)(this.curvePosition)) this.curvePosition = [this.curvePosition, 1 - this.curvePosition];
    var innerPoint1 = {
      x: startPoint.x,
