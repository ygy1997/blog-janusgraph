...
/** @class */
function (_super) {
  (0, _tslib.__extends)(ComboForce, _super);
    ...
    (comboTrees || []).forEach(function (ctree) {
      (0, _graphic.traverseTreeUp)(ctree, function (treeNode) {
        ...
        c.children.forEach(function (child) {
          if (child.itemType !== 'node') {
            var childCombo = comboMap[child.id];
            if (childCombo && (0, _util.isNumber)(childCombo.cx)) c.cx += childCombo.cx;
            if (childCombo && (0, _util.isNumber)(childCombo.cy)) c.cy += childCombo.cy;
            return;
          }
  ...
  ComboForce.prototype.updateComboSizes = function (comboMap) {
    ...
    (comboTrees || []).forEach(function (ctree) {
      ...
      (0, _graphic.traverseTreeUp)(ctree, function (treeNode) {
        ...
        var minSize = self.oriComboMap[treeNode.id].size || _global.default.defaultCombo.size;
