...
/** @class */
function (_super) {
  (0, _tslib.__extends)(ConcentricLayout, _super);
  ...
  ConcentricLayout.prototype.execute = function () {
    ...
    if (self.sortBy === 'degree' || !(0, _util.isString)(self.sortBy) || layoutNodes[0][self.sortBy] === undefined) {
      self.sortBy = 'degree';

      if (!(0, _util.isNumber)(nodes[0].degree)) {
        var values_1 = (0, _math.getDegree)(nodes.length, nodeIdxMap, edges);
        layoutNodes.forEach(function (node, i) {
