...
/** @class */
function (_super) {
  (0, _tslib.__extends)(GForceLayout, _super);
  ...
  GForceLayout.prototype.execute = function () {
    ...
    self.linkDistance = (0, _layout2.proccessToFunc)(self.linkDistance, 1);
    self.nodeStrength = (0, _layout2.proccessToFunc)(self.nodeStrength, 1);
    self.edgeStrength = (0, _layout2.proccessToFunc)(self.edgeStrength, 1); // node size function
    ...
    if (self.preventOverlap) {
      ...
      if ((0, _util.isNumber)(nodeSpacing_1)) {
        nodeSpacingFunc_1 = function nodeSpacingFunc_1() {
          return nodeSpacing_1;
        };
      } else if ((0, _util.isFunction)(nodeSpacing_1)) {
  ...
  GForceLayout.prototype.calAttractive = function (accArray, edges) {
    ...
    edges.forEach(function (edge, i) {
      ...
      var massSource = getMass(sourceNode) || 1;
      var massTarget = getMass(targetNode) || 1;
  ...
  GForceLayout.prototype.calGravity = function (accArray, nodes) {
    ...
    for (var i = 0; i < nodeLength; i++) {
      ...
      if (self.getCenter) {
        ...
        if (customCenterOpt && (0, _util.isNumber)(customCenterOpt[0]) && (0, _util.isNumber)(customCenterOpt[1]) && (0, _util.isNumber)(customCenterOpt[2])) {
