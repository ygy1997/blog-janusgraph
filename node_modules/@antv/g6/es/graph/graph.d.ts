...
import { GraphAnimateConfig, GraphOptions, EdgeConfig, GraphData, Item, ITEM_TYPE, ModelConfig, NodeConfig, NodeMap, Padding, TreeGraphData, ComboConfig, ModeOption, ModeType, States, HullCfg, WaterMarkerConfig, IG6GraphEvent } from '../types';
...
export default class Graph extends EventEmitter implements IGraph {
     ...
     * @return {Item} 元素实例
     */
    addItem(type: ITEM_TYPE, model: ModelConfig, stack?: boolean, sortCombo?: boolean): any;
    /**
     * 新增元素
     * @param {ITEM_TYPE} type 元素类型(node | edge)
     * @param {ModelConfig} model 元素数据模型
     ...
     * @return {Item} 元素实例
     */
    add(type: ITEM_TYPE, model: ModelConfig, stack?: boolean, sortCombo?: boolean): Item;
    /**
     * 更新元素
     * @param {Item} item 元素id或元素实例
