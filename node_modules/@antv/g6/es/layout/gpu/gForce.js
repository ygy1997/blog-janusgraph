...
import { getDegree } from '../../util/math'; // import { gForceCode, aveMovementCode } from './gForceShader';
...
function (_super) {
  ...
  GForceGPULayout.prototype.run = function (canvas, ctx) {
    ...
    var _a = buildTextureDataWithTwoEdgeAttr(nodes, edges, self.linkDistance, self.edgeStrength),
    ...
    var nodeAttributeArray1 = arrayToTextureData([masses, self.degrees, nodeStrengths]); // nodeAttributeArray2 中是：centerX, centerY, gravity, 0, 

    var nodeAttributeArray2 = arrayToTextureData([centerXs, centerYs, centerGravities]);
    ...
    var kernelGForce = world.createKernel(gForceBundle).setDispatch([numParticles, 1, 1]).setBinding({
    ...
    var kernelAveMovement = world.createKernel(aveMovementBundle).setDispatch([1, 1, 1]).setBinding({
      u_Data: nodesEdgesArray,
      VERTEX_COUNT: numParticles,
...
export default GForceGPULayout;