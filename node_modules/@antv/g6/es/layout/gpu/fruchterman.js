...
import { buildTextureData, attributesToTextureData } from '../../util/layout'; // use compiled bundle in prod mode
...
function (_super) {
  ...
  FruchtermanGPULayout.prototype.run = function (canvas, ctx) {
    ...
    var _a = attributesToTextureData([self.clusterField], nodes),
        attributeArray = _a.array,
        clusterCount = _a.count;

    var numParticles = nodes.length;

    var _b = buildTextureData(nodes, edges),
    ...
    var kernelFruchterman = world.createKernel(fruchtermanBundle).setDispatch([numParticles, 1, 1]).setBinding({
...
export default FruchtermanGPULayout;